...
const TaskFieldForm = ({ buttonText, field, handleSubmit, handleDelete }: Props) => {
                    ...
                    {questionType !== "text" &&
                        <>
                            ...
                            {questionType === "truth-or-false" ?
                                <Input name="correctAnswer" defaultValue={field?.correctAnswer || ""} placeholder="v or f"></Input> :
